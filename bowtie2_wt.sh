...
mapfile -t End1 < "groupWT-1"
mapfile -t End2 < "groupWT-2"
...
do
	...
	file1="${End1[$i]}"
	file2="${End2[$i]}"
	bowtie2 -x /home/s2558632/ICA1/Tcongo_genome/Index -1 "$file1" -2 "$file2" -S /home/s2558632/ICA1/Tcongo_genome/2sets_wt.sam -p 1
done
